...
def render():
    ...
    **Contexte :** Ce projet Power BI vise à monitorer la soutenabilité des dépenses de santé liées aux médicaments de ville en France. 
    ...
    with col3:
        # Utilisation de l'image Classe_therapeutique.png ou Focus_classe_therapeutique.png selon votre besoin pour cette section
        # Ici j'utilise Classe_therapeutique.png comme exemple pour la slide 2
