...
def render():
    ...
    st.write(" ")
    st.subheader("Limites et ouvertures")
    ...
    st.write("- Nous ne disposons pas de la période couverte par la création de cet ensemble de données, ni de la provenance de ces valeurs (tous les concessionnaires français ont-ils inclus ces données ou seulement le service d'immatriculation ?).")
    st.write("- Il pourrait également être intéressant d'inclure le type et le prix du véhicule vendu afin d'observer ce qui attire le plus les acheteurs.")